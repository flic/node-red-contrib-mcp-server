...
// middleware used by the mcp-server config node. All external dependencies (HTTP,
// logging, and the jose primitives) are injectable, so tests need neither a live IdP
// nor a running Node-RED.
