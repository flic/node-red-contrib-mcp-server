...
const { createMcpAuth, secretEqual } = require('../lib/mcp-auth');
...
describe('lib/mcp-auth secretEqual', function () {
...
describe('lib/mcp-auth validateToken', function () {
...
describe('lib/mcp-auth OIDC discovery retry', function () {
...
describe('lib/mcp-auth requireBearer', function () {
    function mockRes() {
        return {
